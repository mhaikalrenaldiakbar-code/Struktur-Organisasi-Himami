      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase text-slate-900 tracking-tight">
            GALERI <span className="bg-gradient-to-r from-[#0B25B7] via-blue-600 to-indigo-600 bg-clip-text text-transparent">HIMAMI</span>
          </h2>
        ...
        <div className="flex justify-center flex-wrap gap-3 mb-14">
          {[
            ...
            <motion.button
              ...
              className={`
                px-5 py-3 font-black text-xs md:text-sm rounded-2xl border transition-all cursor-pointer uppercase tracking-wider shadow-md
                ${
                  activeTag === tab.id
          ...
          {filteredItems.map((item, idx) => (
            ...
            >
              <div className="relative h-60 overflow-hidden bg-slate-100">
                ...
                {/* OVERLAY HOVER */}
                <div className="absolute inset-0 bg-blue-950/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center p-4 text-center backdrop-blur-xs">
                  <div className="bg-white text-[#0B25B7] p-3.5 rounded-2xl shadow-xl">
                    <Maximize2 size={22} />
                  </div>
                </div>

                <div className="absolute top-3 left-3 bg-[#0B25B7] text-white text-[10px] font-black px-3 py-1 rounded-full border border-blue-900 uppercase shadow-lg">
                  {item.tag}
                </div>
              </div>
              ...
              <div className="p-5 bg-white border-t border-slate-100">
                <h3 className="font-black text-base text-slate-900 group-hover:text-[#0B25B7] transition-colors line-clamp-1">
                  {item.title}
                </h3>
