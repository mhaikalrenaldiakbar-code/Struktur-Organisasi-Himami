...
import { Mail, Phone, MapPin, Globe, Send, MessageSquare, ChevronDown, CheckCircle2, Shield } from "lucide-react";
...
function Contact() {
  ...
  const faqs = [
    ...
    {
      q: "Di mana sekretariat/lokasi kantor HIMAMI?",
  ...
  return (
    <section
      id="contact"
      className="scroll-mt-20 min-h-screen bg-hex-pattern px-4 md:px-8 py-20 relative overflow-hidden flex flex-col justify-center items-center text-slate-900 border-b border-slate-200"
    >
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-1.5 bg-blue-50 text-[#0B1957] border border-blue-200 px-4 py-1.5 font-black text-xs md:text-sm uppercase rounded-full shadow-sm mb-3">
            <Shield size={14} className="text-amber-500" /> Layanan Informasi & Aspirasi Mahasiswa
          </div>
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight text-[#0B1957]">
            Hubungi Pengurus HIMAMI
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div>
              <h3 className="text-3xl font-black mb-6 uppercase text-[#0B1957] tracking-wide">
              ...
              <div className="space-y-4 text-slate-900">
                ...
                >
                  <MapPin size={22} className="text-[#0B1957] shrink-0" />
                  <div>
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm hover:border-[#0B25B7] hover:translate-x-1 transition-all"
                >
                  <Phone size={22} className="text-[#0B1957] shrink-0" />
                  <div>
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm hover:border-[#0B25B7] hover:translate-x-1 transition-all"
                >
                  <Mail size={22} className="text-[#0B1957] shrink-0" />
                  <div>
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm hover:border-[#0B25B7] hover:translate-x-1 transition-all"
                >
                  <Globe size={22} className="text-[#0B1957] shrink-0" />
                  <div>
                    <span className="text-xs font-black uppercase text-slate-500 block">INSTAGRAM OFFICIAL</span>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full bg-gradient-to-r from-[#0B1957] to-[#0B25B7] hover:from-[#081344] hover:to-[#091E96] text-white border border-amber-400 p-4 rounded-2xl font-black text-sm uppercase flex items-center justify-center gap-2 shadow-lg shadow-blue-900/20 transition-all tracking-wider"
              >
          ...
          >
            ...
            {submitted ? (
              <motion.div
                ...
                className="bg-blue-50/70 border border-blue-200 p-8 rounded-3xl shadow-sm text-center space-y-4"
              >
                <div className="w-16 h-16 bg-[#0B1957] text-amber-400 rounded-2xl flex items-center justify-center mx-auto shadow-md">
                  <CheckCircle2 size={32} />
                </div>
                <h4 className="text-2xl font-black uppercase text-[#0B1957]">PESAN TERKIRIM!</h4>
                <p className="text-sm font-semibold text-slate-700 leading-relaxed">
                  Terima kasih <span className="font-black text-[#0B1957]">{formData.name}</span>. Pesan dan aspirasi kamu telah berhasil terkirim ke sistem pengurus HIMAMI.
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
                  ...
                  className="bg-gradient-to-r from-[#0B1957] to-[#0B25B7] hover:from-[#081344] hover:to-[#091E96] text-white border border-amber-400 px-6 py-2.5 rounded-xl font-black text-xs uppercase shadow-lg transition-all tracking-wider"
                >
                  KIRIM PESAN LAIN
                </button>
              </motion.div>
        ...
        <div className="bg-white border-2 border-slate-200 p-6 md:p-10 rounded-3xl shadow-xl backdrop-blur-md">
          <h3 className="text-2xl font-black uppercase text-[#0B1957] text-center mb-6">
            ...
            {faqs.map((faq, idx) => (
              <div key={idx} className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                <button
                  ...
                  className="w-full p-4 text-left font-black text-sm md:text-base flex items-center justify-between gap-4 text-[#0B1957] hover:text-[#0B25B7] transition-colors"
                >
                  <span>{faq.q}</span>
                  <ChevronDown
                    size={20}
