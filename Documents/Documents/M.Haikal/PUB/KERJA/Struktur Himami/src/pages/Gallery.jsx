      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-1.5 bg-blue-50 text-[#0B1957] border border-blue-200 px-4 py-1.5 font-black text-xs md:text-sm uppercase rounded-full shadow-sm mb-3">
            <ImageIcon size={14} className="text-amber-500" /> Dokumen & Rekam Jejak Kegiatan
          </div>
        ...
        <div className="flex justify-center flex-wrap gap-2.5 mb-12">
          {[
            ...
            <button
              ...
              className={`
                px-4 py-2 font-black text-xs rounded-2xl border transition-all cursor-pointer uppercase tracking-wider shadow-sm
                ${
                  activeTag === tab.id
          ...
          {filteredItems.map((item, idx) => (
            ...
            >
              <div className="relative h-56 overflow-hidden bg-slate-100">
                ...
                {/* OVERLAY HOVER */}
                <div className="absolute inset-0 bg-[#0B1957]/70 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center p-4 text-center">
                  <div className="bg-white text-[#0B1957] p-3 rounded-2xl shadow-lg border border-amber-400">
                    <Maximize2 size={20} />
                  </div>
                </div>

                <div className="absolute top-3 left-3 bg-[#0B1957] text-amber-300 text-[10px] font-black px-3 py-0.5 rounded-full border border-amber-400 uppercase shadow-md">
                  {item.tag}
                </div>
              </div>
              ...
              <div className="p-4 bg-white border-t border-slate-100">
                <h3 className="font-black text-sm text-[#0B1957] group-hover:text-[#0B25B7] transition-colors line-clamp-1">
                  {item.title}
                </h3>
      ...
      <AnimatePresence>
        {selectedIndex !== null && filteredItems[selectedIndex] && (
          ...
          >
            ...
            <button
              onClick={() => setSelectedIndex(null)}
              className="absolute top-6 right-6 bg-white text-slate-800 p-3 rounded-2xl border border-slate-300 hover:bg-red-600 hover:text-white z-50 cursor-pointer transition-all shadow-md"
            >
              <X size={24} />
            </button>
            ...
            <button
              ...
              className="absolute left-4 bg-white text-[#0B1957] p-3 rounded-2xl border border-slate-300 hover:bg-[#0B1957] hover:text-amber-400 z-50 cursor-pointer hidden sm:block transition-all shadow-lg"
            >
              <ChevronLeft size={28} />
            </button>
            ...
            <button
              ...
              className="absolute right-4 bg-white text-[#0B1957] p-3 rounded-2xl border border-slate-300 hover:bg-[#0B1957] hover:text-amber-400 z-50 cursor-pointer hidden sm:block transition-all shadow-lg"
            >
            ...
            <motion.div
              ...
              className="bg-white border-4 border-[#0B1957] rounded-3xl shadow-2xl max-w-4xl w-full overflow-hidden text-slate-900"
            >
              ...
              <div className="p-6 bg-white flex flex-col md:flex-row items-center justify-between gap-4 border-t border-slate-100">
                <div>
                  <span className="bg-amber-100 text-amber-900 border border-amber-300 px-3 py-1 font-black text-xs uppercase rounded-full">
                    {filteredItems[selectedIndex].tag}
                  </span>
                  <h3 className="text-xl font-black text-[#0B1957] uppercase mt-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => setSelectedIndex(null)}
                    className="bg-gradient-to-r from-[#0B1957] to-[#0B25B7] hover:from-[#081344] hover:to-[#091E96] text-white px-6 py-2.5 rounded-xl border border-amber-400 font-black text-xs shadow-lg shadow-blue-900/30 transition-all uppercase tracking-wider"
                  >
                    TUTUP
                  </button>
                </div>
